...
function setTheme(theme) {
  ...
  if (theme === 'light') {
    if (navLogo) navLogo.src = 'assets/images/logo-icon-black-cropped.png';
    if (footerLogo) footerLogo.src = 'assets/images/logo-icon-black-cropped.png';
    if (favicon) favicon.href = 'assets/images/logo-icon-black-cropped.png';
    if (triggerLogo) triggerLogo.src = 'assets/images/logo-icon-black-cropped.png';
    if (headerLogo) headerLogo.src = 'assets/images/logo-icon-black-cropped.png';
    if (centerBadgeLogo) centerBadgeLogo.src = 'assets/images/logo-icon-black-cropped.png';
    if (themeIcon) {
      themeIcon.innerHTML = `<circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/>`;
    }
  } else {
    if (navLogo) navLogo.src = 'assets/images/logo-dark-cropped.png';
    if (footerLogo) footerLogo.src = 'assets/images/logo-dark-cropped.png';
